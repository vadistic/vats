...
export namespace QueryResolvers {
  ...
  export type SourceResolver<R = Maybe<Source>, Parent = {}, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    SourceArgs
  ...
  export type SourcesResolver<R = (Maybe<Source>)[], Parent = {}, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    SourcesArgs
  ...
  export type SourcesConnectionResolver<R = SourceConnection, Parent = {}, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    SourcesConnectionArgs
  >
...
export namespace UserResolvers {
  ...
  export type UpdatedAtResolver<R = DateTime, Parent = User, Context = {}> = Resolver<
    ...
    Context
  >
  export type SettingsResolver<R = Maybe<Json>, Parent = User, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace CandidateResolvers {
  ...
  export type AvatarResolver<R = Maybe<File>, Parent = Candidate, Context = {}> = Resolver<
    ...
    Context
  >
  export type CompanyResolver<R = Maybe<string>, Parent = Candidate, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type HeadlineResolver<R = Maybe<string>, Parent = Candidate, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type PositionResolver<R = Maybe<string>, Parent = Candidate, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  ...
  export type SourcesResolver<R = Maybe<Source[]>, Parent = Candidate, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    SourcesArgs
...
export namespace TagResolvers {
  ...
  export type DescriptionResolver<R = Maybe<string>, Parent = Tag, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace SourceResolvers {
  ...
  export type CreatedAtResolver<R = DateTime, Parent = Source, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type UpdatedAtResolver<R = DateTime, Parent = Source, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type LabelResolver<R = string, Parent = Source, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type DescriptionResolver<R = Maybe<string>, Parent = Source, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace FieldResolvers {
  ...
  export type DescriptionResolver<R = Maybe<string>, Parent = Field, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace JobResolvers {
  ...
  export type ExcerptResolver<R = Maybe<string>, Parent = Job, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type CompanyDescriptionResolver<R = Maybe<string>, Parent = Job, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace WorkspaceResolvers {
  ...
  export type SettingsResolver<R = Maybe<Json>, Parent = Workspace, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace LocationResolvers {
  ...
  export type CreatedAtResolver<R = DateTime, Parent = Location, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type UpdatedAtResolver<R = DateTime, Parent = Location, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type CountryResolver<R = string, Parent = Location, Context = {}> = Resolver<
    ...
    Context
  >
  export type RegionResolver<R = Maybe<string>, Parent = Location, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type CityResolver<R = string, Parent = Location, Context = {}> = Resolver<
    ...
    Context
  >
  export type ZipResolver<R = Maybe<string>, Parent = Location, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace SourceConnectionResolvers {
  ...
  export type PageInfoResolver<R = PageInfo, Parent = SourceConnection, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace SourceEdgeResolvers {
  ...
  export type NodeResolver<R = Source, Parent = SourceEdge, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
  export type CursorResolver<R = string, Parent = SourceEdge, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace AggregateSourceResolvers {
  ...
  export type CountResolver<R = number, Parent = AggregateSource, Context = {}> = Resolver<
    R,
    Parent,
    Context
  >
...
export namespace MutationResolvers {
  ...
  export type CreateSourceResolver<R = Source, Parent = {}, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    CreateSourceArgs
  ...
  export type UpdateSourceResolver<R = Maybe<Source>, Parent = {}, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    UpdateSourceArgs
  ...
  export type UpsertSourceResolver<R = Source, Parent = {}, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    UpsertSourceArgs
  ...
  export type DeleteSourceResolver<R = Maybe<Source>, Parent = {}, Context = {}> = Resolver<
    R,
    Parent,
    Context,
    DeleteSourceArgs
