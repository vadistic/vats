...
export interface QueryResolvers<Context = {}, TypeParent = {}> {
  application?: QueryApplicationResolver<
    Maybe<Application>,
    TypeParent,
    Context
  >;
...
export type QueryApplicationResolver<
  R = Maybe<Application>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryApplicationArgs>;
export interface QueryApplicationArgs {
  where: ApplicationWhereUniqueInput;
}

export type QueryApplicationsResolver<
  R = Application[],
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryApplicationsArgs>;
...
export type QueryCandidateResolver<
  R = Maybe<Candidate>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryCandidateArgs>;
export interface QueryCandidateArgs {
  where: CandidateWhereUniqueInput;
}

export type QueryCandidatesResolver<
  R = Candidate[],
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryCandidatesArgs>;
...
export type QueryJobResolver<
  R = Maybe<Job>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryJobArgs>;
...
export type QueryTagResolver<
  R = Maybe<Tag>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryTagArgs>;
...
export type QueryTaskResolver<
  R = Maybe<Task>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryTaskArgs>;
export interface QueryTaskArgs {
  where: TaskWhereUniqueInput;
}

export type QueryTasksResolver<
  R = Task[],
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryTasksArgs>;
...
export type QueryUserResolver<
  ...
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryUserArgs>;
...
export type QueryUsersResolver<
  ...
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, QueryUsersArgs>;
...
export type QueryLocalFieldResolver<
  R = string,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context>;
export type QueryLocalTypeResolver<
  R = LocalType,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type ApplicationDisqualificationResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type ApplicationStageResolver<
  R = Stage,
  Parent = Application,
  Context = {}
> = Resolver<R, Parent, Context>;
export type ApplicationJobResolver<
  R = Job,
  Parent = Application,
  Context = {}
> = Resolver<R, Parent, Context>;
...
> {
  ...
  createdAt?: DisqualificationInstanceCreatedAtResolver<
    DateTime,
    TypeParent,
    Context
  >;

  updatedAt?: DisqualificationInstanceUpdatedAtResolver<
    DateTime,
    TypeParent,
    Context
  >;
  ...
  createdBy?: DisqualificationInstanceCreatedByResolver<
    User,
    TypeParent,
    Context
  >;

  content?: DisqualificationInstanceContentResolver<
    Maybe<string>,
    TypeParent,
    Context
  >;
...
export interface DisqualificationResolvers<
  Context = {},
  TypeParent = Disqualification
> {
  ...
  description?: DisqualificationDescriptionResolver<
    Maybe<string>,
    TypeParent,
    Context
  >;
...
export type UserUpdatedAtResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type UserTasksResolver<
  R = Maybe<Task[]>,
  Parent = User,
  Context = {}
> = Resolver<R, Parent, Context, UserTasksArgs>;
...
export type UserFirstNameResolver<
  R = string,
  Parent = User,
  Context = {}
> = Resolver<R, Parent, Context>;
export type UserLastNameResolver<
  R = string,
  Parent = User,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type UserUsernameResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type UserLastLoginResolver<
  R = Maybe<DateTime>,
  Parent = User,
  Context = {}
> = Resolver<R, Parent, Context>;
export type UserDeletedAtResolver<
  R = Maybe<DateTime>,
  Parent = User,
  Context = {}
> = Resolver<R, Parent, Context>;
export type UserPositionResolver<
  R = Maybe<string>,
  Parent = User,
  Context = {}
> = Resolver<R, Parent, Context>;
export type UserAvatarResolver<
  R = Maybe<File>,
  Parent = User,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type TaskIdResolver<R = string, Parent = Task, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;
export type TaskCreatedAtResolver<
  R = DateTime,
  Parent = Task,
  Context = {}
> = Resolver<R, Parent, Context>;
export type TaskUpdatedAtResolver<
  R = DateTime,
  Parent = Task,
  Context = {}
> = Resolver<R, Parent, Context>;
export type TaskOwnersResolver<
  R = Maybe<User[]>,
  Parent = Task,
  Context = {}
> = Resolver<R, Parent, Context, TaskOwnersArgs>;
...
export type TaskCandidateResolver<
  R = Maybe<Candidate>,
  Parent = Task,
  Context = {}
> = Resolver<R, Parent, Context>;
export type TaskTitleResolver<
  R = Maybe<string>,
  Parent = Task,
  Context = {}
> = Resolver<R, Parent, Context>;
export type TaskDescriptionResolver<
  R = Maybe<string>,
  Parent = Task,
  Context = {}
> = Resolver<R, Parent, Context>;
export type TaskDueAtResolver<
  R = Maybe<DateTime>,
  Parent = Task,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export interface CandidateResolvers<Context = {}, TypeParent = Candidate> {
  ...
  metaCompany?: CandidateMetaCompanyResolver<
    Maybe<string>,
    TypeParent,
    Context
  >;

  metaHeadline?: CandidateMetaHeadlineResolver<
    Maybe<string>,
    TypeParent,
    Context
  >;

  metaPosition?: CandidateMetaPositionResolver<
    Maybe<string>,
    TypeParent,
    Context
  >;
  ...
  resumesFile?: CandidateResumesFileResolver<
    Maybe<File[]>,
    TypeParent,
    Context
  >;

  coverLettersString?: CandidateCoverLettersStringResolver<
    string[],
    TypeParent,
    Context
  >;

  coverLettersFile?: CandidateCoverLettersFileResolver<
    Maybe<File[]>,
    TypeParent,
    Context
  >;
  ...
  applications?: CandidateApplicationsResolver<
    Maybe<Application[]>,
    TypeParent,
    Context
  >;
...
export type CandidateIdResolver<
  R = string,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidateCreatedAtResolver<
  R = DateTime,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidateUpdatedAtResolver<
  R = DateTime,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidateFirstNameResolver<
  R = string,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidateLastNameResolver<
  R = string,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidateEmailsResolver<
  R = string[],
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidatePhonesResolver<
  R = string[],
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidateLinksResolver<
  R = string[],
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CandidateAvatarResolver<
  R = Maybe<File>,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type CandidateTagsResolver<
  R = Maybe<Tag[]>,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context, CandidateTagsArgs>;
...
export type CandidateTasksResolver<
  R = Maybe<Task[]>,
  Parent = Candidate,
  Context = {}
> = Resolver<R, Parent, Context, CandidateTasksArgs>;
...
export type FileIdResolver<R = string, Parent = File, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;
export type FileCreatedAtResolver<
  R = DateTime,
  Parent = File,
  Context = {}
> = Resolver<R, Parent, Context>;
export type FileUpdatedAtResolver<
  R = DateTime,
  Parent = File,
  Context = {}
> = Resolver<R, Parent, Context>;
export type FileSizeResolver<
  R = number,
  Parent = File,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type FileNameResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type FileUrlResolver<R = string, Parent = File, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;
...
export type TagIdResolver<R = string, Parent = Tag, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;
export type TagCreatedAtResolver<
  R = DateTime,
  Parent = Tag,
  Context = {}
> = Resolver<R, Parent, Context>;
export type TagUpdatedAtResolver<
  R = DateTime,
  Parent = Tag,
  Context = {}
> = Resolver<R, Parent, Context>;
export type TagLabelResolver<R = string, Parent = Tag, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;

export interface FieldInstanceResolvers<
  Context = {},
  TypeParent = FieldInstance
> {
...
export type FieldInstanceIdResolver<
  R = string,
...
export type FieldInstanceUpdatedAtResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type FieldInstanceFieldResolver<
  R = Field,
  Parent = FieldInstance,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type FieldIdResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type FieldCreatedAtResolver<
  R = DateTime,
  Parent = Field,
  Context = {}
> = Resolver<R, Parent, Context>;
export type FieldUpdatedAtResolver<
  R = DateTime,
  Parent = Field,
  Context = {}
> = Resolver<R, Parent, Context>;
export type FieldTypeResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type FieldLabelResolver<
  R = string,
  Parent = Field,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type CommentIdResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type CommentCreatedAtResolver<
  R = DateTime,
  Parent = Comment,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CommentUpdatedAtResolver<
  R = DateTime,
  Parent = Comment,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CommentCreatedByResolver<
  R = User,
  Parent = Comment,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CommentParentResolver<
  R = Maybe<Comment>,
  Parent = Comment,
  Context = {}
> = Resolver<R, Parent, Context>;
export type CommentContentResolver<
  R = string,
  Parent = Comment,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type StageIdResolver<
  R = string,
  Parent = Stage,
  Context = {}
> = Resolver<R, Parent, Context>;
export type StageCreatedAtResolver<
  R = DateTime,
  Parent = Stage,
  Context = {}
> = Resolver<R, Parent, Context>;
export type StageUpdatedAtResolver<
  R = DateTime,
  Parent = Stage,
  Context = {}
> = Resolver<R, Parent, Context>;
export type StageNameResolver<
  R = string,
  Parent = Stage,
  Context = {}
> = Resolver<R, Parent, Context>;
export type StageDescriptionResolver<
  R = Maybe<string>,
  Parent = Stage,
  Context = {}
> = Resolver<R, Parent, Context>;
export type StageTypeResolver<
  R = StageType,
  Parent = Stage,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export interface JobResolvers<Context = {}, TypeParent = Job> {
  ...
  applications?: JobApplicationsResolver<
    Maybe<Application[]>,
    TypeParent,
    Context
  >;
...
export type JobIdResolver<R = string, Parent = Job, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;
export type JobCreatedAtResolver<
  R = DateTime,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context>;
export type JobUpdatedAtResolver<
  R = DateTime,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context>;
export type JobWorkspaceResolver<
  R = Workspace,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type JobWorkflowResolver<
  R = Workflow,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context>;
export type JobCommentsResolver<
  R = Maybe<Comment[]>,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context, JobCommentsArgs>;
...
export type JobTypeResolver<R = JobType, Parent = Job, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;
export type JobDepartmentResolver<
  R = Maybe<string>,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context>;
export type JobLocationsResolver<
  R = Maybe<Location[]>,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context, JobLocationsArgs>;
...
export type JobNameResolver<R = string, Parent = Job, Context = {}> = Resolver<
  R,
  Parent,
  Context
>;
export type JobDescriptionResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type JobRequirementsResolver<
  R = Maybe<string>,
  Parent = Job,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export interface WorkspaceResolvers<Context = {}, TypeParent = Workspace> {
  ...
  candidates?: WorkspaceCandidatesResolver<
    Maybe<Candidate[]>,
    TypeParent,
    Context
  >;

  workflows?: WorkspaceWorkflowsResolver<
    Maybe<Workflow[]>,
    TypeParent,
    Context
  >;
...
export type WorkspaceIdResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type WorkspaceCreatedAtResolver<
  R = DateTime,
  Parent = Workspace,
  Context = {}
> = Resolver<R, Parent, Context>;
export type WorkspaceUpdatedAtResolver<
  R = DateTime,
  Parent = Workspace,
  Context = {}
> = Resolver<R, Parent, Context>;
export type WorkspaceUsersResolver<
  R = Maybe<User[]>,
  Parent = Workspace,
  Context = {}
> = Resolver<R, Parent, Context, WorkspaceUsersArgs>;
...
export type WorkspaceJobsResolver<
  R = Maybe<Job[]>,
  Parent = Workspace,
  Context = {}
> = Resolver<R, Parent, Context, WorkspaceJobsArgs>;
...
export type WorkspaceTagsResolver<
  R = Maybe<Tag[]>,
  Parent = Workspace,
  Context = {}
> = Resolver<R, Parent, Context, WorkspaceTagsArgs>;
...
export type WorkspaceNameResolver<
  R = string,
  Parent = Workspace,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type WorkflowIdResolver<
  R = string,
  Parent = Workflow,
  Context = {}
> = Resolver<R, Parent, Context>;
export type WorkflowCreatedAtResolver<
  R = DateTime,
  Parent = Workflow,
  Context = {}
> = Resolver<R, Parent, Context>;
export type WorkflowUpdatedAtResolver<
  R = DateTime,
  Parent = Workflow,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type WorkflowDescriptionResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type WorkflowStagesResolver<
  R = Maybe<Stage[]>,
  Parent = Workflow,
  Context = {}
> = Resolver<R, Parent, Context, WorkflowStagesArgs>;
...
export type WorkflowFieldsResolver<
  R = Maybe<Field[]>,
  Parent = Workflow,
  Context = {}
> = Resolver<R, Parent, Context, WorkflowFieldsArgs>;
...
export type InviteIdResolver<
  R = string,
  Parent = Invite,
  Context = {}
> = Resolver<R, Parent, Context>;
export type InviteCreatedAtResolver<
  R = DateTime,
  Parent = Invite,
  Context = {}
> = Resolver<R, Parent, Context>;
export type InviteUpdatedAtResolver<
  R = DateTime,
  Parent = Invite,
  Context = {}
> = Resolver<R, Parent, Context>;
export type InviteEmailResolver<
  R = string,
  Parent = Invite,
  Context = {}
> = Resolver<R, Parent, Context>;
export type InviteExpireAtResolver<
  R = DateTime,
  Parent = Invite,
  Context = {}
> = Resolver<R, Parent, Context>;
export type InviteInvitedByResolver<
  R = User,
  Parent = Invite,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type LocationCountryResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type LocationRegionResolver<
  R = string,
  Parent = Location,
  Context = {}
> = Resolver<R, Parent, Context>;
export type LocationCityResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type LocationZipResolver<
  R = string,
  Parent = Location,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type LocalTypeIdResolver<
  R = string,
  Parent = LocalType,
  Context = {}
> = Resolver<R, Parent, Context>;
export type LocalTypeNameResolver<
  R = string,
  Parent = LocalType,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export interface MutationResolvers<Context = {}, TypeParent = {}> {
  createApplication?: MutationCreateApplicationResolver<
    Application,
    TypeParent,
    Context
  >;

  updateApplication?: MutationUpdateApplicationResolver<
    Maybe<Application>,
    TypeParent,
    Context
  >;

  upsertApplication?: MutationUpsertApplicationResolver<
    Application,
    TypeParent,
    Context
  >;

  deleteApplication?: MutationDeleteApplicationResolver<
    Maybe<Application>,
    TypeParent,
    Context
  >;

  createCandidate?: MutationCreateCandidateResolver<
    Candidate,
    TypeParent,
    Context
  >;

  updateCandidate?: MutationUpdateCandidateResolver<
    Maybe<Candidate>,
    TypeParent,
    Context
  >;

  upsertCandidate?: MutationUpsertCandidateResolver<
    Candidate,
    TypeParent,
    Context
  >;

  deleteCandidate?: MutationDeleteCandidateResolver<
    Maybe<Candidate>,
    TypeParent,
    Context
  >;
...
export type MutationCreateCandidateResolver<
  R = Candidate,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationCreateCandidateArgs>;
...
export type MutationUpsertCandidateResolver<
  R = Candidate,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationUpsertCandidateArgs>;
...
export type MutationCreateJobResolver<
  R = Job,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationCreateJobArgs>;
export interface MutationCreateJobArgs {
  data: JobCreateInput;
}

export type MutationUpdateJobResolver<
  R = Maybe<Job>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationUpdateJobArgs>;
...
export type MutationUpsertJobResolver<
  R = Job,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationUpsertJobArgs>;
...
export type MutationDeleteJobResolver<
  R = Maybe<Job>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationDeleteJobArgs>;
export interface MutationDeleteJobArgs {
  where: JobWhereUniqueInput;
}

export type MutationCreateTagResolver<
  R = Tag,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationCreateTagArgs>;
export interface MutationCreateTagArgs {
  data: TagCreateInput;
}

export type MutationUpdateTagResolver<
  R = Maybe<Tag>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationUpdateTagArgs>;
...
export type MutationUpsertTagResolver<
  R = Tag,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationUpsertTagArgs>;
...
export type MutationDeleteTagResolver<
  R = Maybe<Tag>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationDeleteTagArgs>;
export interface MutationDeleteTagArgs {
  where: TagWhereUniqueInput;
}

export type MutationCreateTaskResolver<
  R = Task,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationCreateTaskArgs>;
export interface MutationCreateTaskArgs {
  data: TaskCreateInput;
}

export type MutationUpdateTaskResolver<
  R = Maybe<Task>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationUpdateTaskArgs>;
...
export type MutationUpsertTaskResolver<
  R = Task,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationUpsertTaskArgs>;
...
export type MutationDeleteTaskResolver<
  R = Maybe<Task>,
  Parent = {},
  Context = {}
> = Resolver<R, Parent, Context, MutationDeleteTaskArgs>;
export interface MutationDeleteTaskArgs {
  where: TaskWhereUniqueInput;
}

export interface AccessPayloadResolvers<
  Context = {},
  TypeParent = AccessPayload
> {
  token?: AccessPayloadTokenResolver<string, TypeParent, Context>;
}

export type AccessPayloadTokenResolver<
  R = string,
  Parent = AccessPayload,
  Context = {}
> = Resolver<R, Parent, Context>;
...
export type AuthPayloadTokenResolver<
  ...
  Context = {}
> = Resolver<R, Parent, Context>;
export type AuthPayloadRefreshResolver<
  R = string,
  Parent = AuthPayload,
  Context = {}
> = Resolver<R, Parent, Context>;
