...
type Mutation {
  ...
  createReviewInstance(data: ReviewInstanceCreateInput!): ReviewInstance!
  updateReviewInstance(data: ReviewInstanceUpdateInput!, where: ReviewInstanceWhereUniqueInput!): ReviewInstance
  updateManyReviewInstances(data: ReviewInstanceUpdateManyMutationInput!, where: ReviewInstanceWhereInput): BatchPayload!
  upsertReviewInstance(where: ReviewInstanceWhereUniqueInput!, create: ReviewInstanceCreateInput!, update: ReviewInstanceUpdateInput!): ReviewInstance!
  deleteReviewInstance(where: ReviewInstanceWhereUniqueInput!): ReviewInstance
  deleteManyReviewInstances(where: ReviewInstanceWhereInput): BatchPayload!
...
type Query {
  ...
  reviewInstance(where: ReviewInstanceWhereUniqueInput!): ReviewInstance
  reviewInstances(where: ReviewInstanceWhereInput, orderBy: ReviewInstanceOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [ReviewInstance]!
  reviewInstancesConnection(where: ReviewInstanceWhereInput, orderBy: ReviewInstanceOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ReviewInstanceConnection!
...
type ReviewInstanceConnection {
  pageInfo: PageInfo!
  edges: [ReviewInstanceEdge]!
  aggregate: AggregateReviewInstance!
}
...
type ReviewInstancePreviousValues {
  id: ID!
  createdAt: DateTime!
  updatedAt: DateTime!
  rating: Int
...
type ReviewInstanceSubscriptionPayload {
  mutation: MutationType!
  node: ReviewInstance
  updatedFields: [String!]
...
input ReviewInstanceSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ReviewInstanceWhereInput
  AND: [ReviewInstanceSubscriptionWhereInput!]
  OR: [ReviewInstanceSubscriptionWhereInput!]
  NOT: [ReviewInstanceSubscriptionWhereInput!]
}
...
input ReviewInstanceUpdateInput {
  prototype: ReviewUpdateOneInput
  fields: FieldInstanceUpdateManyInput
  createdBy: UserUpdateOneRequiredInput
  rating: Int
...
input ReviewInstanceUpdateManyMutationInput {
  rating: Int
  content: String
}
...
type Subscription {
  ...
  reviewInstance(where: ReviewInstanceSubscriptionWhereInput): ReviewInstanceSubscriptionPayload
